...
class IPTV extends TV{
	...
	public void printProperty(){
		System.out.printf("나의 IPTV는 %s주소의 %d인치 %d컬러\n", ip, getSize(),color);}
}
...
//		myTV.printProperty();
		...
		// [2번] 다음 main() 메소드와 실행 결과를 참고하여 ColorTV를 상속받은 IPTV 클래스를 작성하라.
		IPTV iptv = new IPTV("192.1.1.2", 32, 2048); // "192.1.1.2" 주소에 32인치, 1048 컬러
		myTV.printProperty();
