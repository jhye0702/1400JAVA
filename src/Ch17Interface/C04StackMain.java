...
class StringStack implements Stack {
   ...
   private String[] stack; // 배열형 스택
   public StringStack(int num) {  //Stack 이라는 배열의 크기를 전달받아 공간의 크기를 정함.
      this.num = num;
      this.set = 0;  //push라는 작업을 통해 가장 마지막에 담긴 Top의 값까지 +1씩 증가시키는 방법.
